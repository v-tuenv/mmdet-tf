...
class AnchorHeadSpaceSTORMTF(BaseDenseHeadSpaceSTORM):
    ...
    def __init__(
        ...
        super(AnchorHeadSpaceSTORMTF,self).__init__(init_cfg)
    ...
    def mloss(self,
        ...
        cls_scores = tf.concat(cls_scores, axis=0) # Batch_size*num_bbox, cls_out_channels
